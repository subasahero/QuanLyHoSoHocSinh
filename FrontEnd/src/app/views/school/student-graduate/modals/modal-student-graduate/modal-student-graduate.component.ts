...
import { ViewDiemHocSinhTotNghiepComponent } from '../view-diem-hoc-sinh-tot-nghiep/view-diem-hoc-sinh-tot-nghiep.component';
...
export class ModalStudentGraduateComponent implements OnInit {
  ...
  view61(data: any) {
    const drawerRef = this.drawerService.create({
      ...
      nzContent: ViewDiemHocSinhTotNghiepComponent,
      nzWidth: 650,
      nzContentParams: {
