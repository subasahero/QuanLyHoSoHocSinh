...
@Component({
  selector: 'app-student-list-seven',
  templateUrl: './student-list-seven.component.html',
  styleUrls: ['./student-list-seven.component.css']
})
export class StudentListSevenComponent implements OnInit {
  ...
  ngOnInit() {
    this.loading = true;
    this.studentService.GetStudentByLevelPaging(this.pageNumber, this.pageSize, '1').subscribe(
  ...
  loadData(reset: boolean = false) {
    ...
    this.loading = true;
    this.studentService.GetStudentByLevelPaging(pagination.currentPage, pagination.itemsPerPage, '1', this.pagingParams)
