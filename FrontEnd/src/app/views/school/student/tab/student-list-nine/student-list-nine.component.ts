...
@Component({
  selector: 'app-student-list-nine',
  templateUrl: './student-list-nine.component.html',
  styleUrls: ['./student-list-nine.component.css']
})
export class StudentListNineComponent implements OnInit {
