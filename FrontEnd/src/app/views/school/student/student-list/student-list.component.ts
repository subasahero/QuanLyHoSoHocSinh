...
export class StudentListComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.data.subscribe(data => {
      this.loading = false;
      this.pagination = data['student-list'].pagination;
      this.dataSet = data['student-list'].result;
  ...
  loadData(reset: boolean = false) {
    ...
    this.loading = true;
    this.studentService.getAllPaging(this.pagination.currentPage, this.pagination.itemsPerPage, this.pagingParams)
